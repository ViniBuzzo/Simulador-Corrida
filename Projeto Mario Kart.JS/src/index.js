...
//teste habilidade
    ...
    if(block === "CONFRONTO"){
        ...
        if (powerResult1 > powerResult2 && character2.PONTOS > 0) {
            ...
            console.log(`${character2.NOME} não perde ponto, já está com 0 pontos.`);
        }
    
        // Verifica se player2 venceu o confronto e se player1 tem mais de 0 pontos para perder
        if (powerResult2 > powerResult1 && character1.PONTOS > 0) {
            character1.PONTOS--;
            console.log(`${character2.NOME} venceu o confronto! ${character1.NOME} perdeu um ponto.`);
        } else if (powerResult2 > powerResult1 && character1.PONTOS <= 0) {
            console.log(`${character1.NOME} não perde ponto, já está com 0 pontos.`);
        }
    ...
    if(testSkill1 > testSkill2){
        ...
        console.log("Confronto empatado, nenhum ponto ganho")
    }
    console.log("--------------")
}
}
